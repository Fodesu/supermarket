...
MCP servers often act as OAuth clients too. Your server sits between Memoh and a third-party API like GitHub. To Memoh, you're a server. To GitHub, you're a client. This lets users authenticate with their GitHub credentials.
